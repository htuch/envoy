...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_iovisor_ubpf = dict(
        ...
        version = "9ee9e3372d5b2a4b18f73c5dd58935ce08e2821f",
        sha256 = "afd42a1f266e69321a32b17caf1c243b8e49436ce3d152589f324b8b26ee416e",
        strip_prefix = "ubpf-{version}",
        urls = ["https://github.com/iovisor/ubpf/archive/{version}.tar.gz"],
